  ...
  // Renvoie un objet de connexion à la BD en initialisant la connexion au besoin
	...
	{		
		if ($this->bdd == null)
		{
		  ...
		  $this->bdd = new PDO('mysql:host=localhost;dbname=famly;charset=utf8',
...
function getBDD()
{
	$bddhost="host=localhost";
	$bddname="dbname=famly";
	$bddlogin="root";
	$bddmdp="";

	try
	{
		//$bdd = new PDO('mysql:$bddhost, $bddname, $bddlogin, $bddmdp');
		$bdd = new PDO('mysql:host=localhost; dbname=famly' , 'root','');
